#!/bin/bash
# GPT4.1 GPT4 GRNB2_Bottom GRNB2_Random GRNB2 DeepSEM Llama Llama_New PIDC
for GRN in GRNB2_eps10 GRNB2_eps20 GRNB2_eps40 GRNB2_eps50 GRNB2_eps100 GRNB2_eps1000
do
