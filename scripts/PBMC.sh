# Stage1
# srun --exclusive --gres=gpu:1 --ntasks=1 --nodes=1 --ntasks-per-node=1 -o "$LOG_DIR/out-stage1-PBMC-1.txt" -e "$LOG_DIR/error-stage1-PBMC-1.txt"  env CUDA_VISIBLE_DEVICES=0  python src/main.py --config ${PROJECT_DIR}/configs/PBMC/CrossVal_1000/Stage1.cfg --train&
# srun --exclusive --gres=gpu:1 --ntasks=1 --nodes=1 --ntasks-per-node=1 -o "$LOG_DIR/out-stage1-PBMC-2.txt" -e "$LOG_DIR/error-stage1-PBMC-2.txt"  env CUDA_VISIBLE_DEVICES=1  python src/main.py --config ${PROJECT_DIR}/configs/PBMC/CrossVal_2000/Stage1.cfg --train&
# srun --exclusive --gres=gpu:1 --ntasks=1 --nodes=1 --ntasks-per-node=1 -o "$LOG_DIR/out-stage1-PBMC-3.txt" -e "$LOG_DIR/error-stage1-PBMC-3.txt"  env CUDA_VISIBLE_DEVICES=2  python src/main.py --config ${PROJECT_DIR}/configs/PBMC/CrossVal_3000/Stage1.cfg --train&
# srun --exclusive --gres=gpu:1 --ntasks=1 --nodes=1 --ntasks-per-node=1 -o "$LOG_DIR/out-stage1-PBMC-4.txt" -e "$LOG_DIR/error-stage1-PBMC-4.txt"  env CUDA_VISIBLE_DEVICES=3  python src/main.py --config ${PROJECT_DIR}/configs/PBMC/CrossVal_4000/Stage1.cfg --train&
# wait
...
srun --exclusive --gres=gpu:1 --ntasks=1 --nodes=1 --ntasks-per-node=1 -o "$LOG_DIR/out-stage2-${TAG}-2.txt" -e "$LOG_DIR/error-stage2-${TAG}-2.txt"  env CUDA_VISIBLE_DEVICES=1  python src/main.py --config ${PROJECT_DIR}/configs/PBMC/CrossVal_2000/KB_Sapien/freq_None/Seed1/GRNB2.cfg --train&
srun --exclusive --gres=gpu:1 --ntasks=1 --nodes=1 --ntasks-per-node=1 -o "$LOG_DIR/out-stage2-${TAG}-3.txt" -e "$LOG_DIR/error-stage2-${TAG}-3.txt"  env CUDA_VISIBLE_DEVICES=2  python src/main.py --config ${PROJECT_DIR}/configs/PBMC/CrossVal_3000/KB_Sapien/freq_None/Seed1/GRNB2.cfg --train&
srun --exclusive --gres=gpu:1 --ntasks=1 --nodes=1 --ntasks-per-node=1 -o "$LOG_DIR/out-stage2-${TAG}-4.txt" -e "$LOG_DIR/error-stage2-${TAG}-4.txt"  env CUDA_VISIBLE_DEVICES=3  python src/main.py --config ${PROJECT_DIR}/configs/PBMC/CrossVal_4000/KB_Sapien/freq_None/Seed1/GRNB2.cfg --train&
wait
...
srun --exclusive --gres=gpu:1 --ntasks=1 --nodes=1 --ntasks-per-node=1 -o "$LOG_DIR/out-stage2-${TAG}-2.txt" -e "$LOG_DIR/error-stage2-${TAG}-2.txt"  env CUDA_VISIBLE_DEVICES=1  python src/main.py --config ${PROJECT_DIR}/configs/PBMC/CrossVal_2000/KB_Sapien/freq_None/Seed1/GRNB2.cfg --generate&
srun --exclusive --gres=gpu:1 --ntasks=1 --nodes=1 --ntasks-per-node=1 -o "$LOG_DIR/out-stage2-${TAG}-3.txt" -e "$LOG_DIR/error-stage2-${TAG}-3.txt"  env CUDA_VISIBLE_DEVICES=2  python src/main.py --config ${PROJECT_DIR}/configs/PBMC/CrossVal_3000/KB_Sapien/freq_None/Seed1/GRNB2.cfg --generate&
