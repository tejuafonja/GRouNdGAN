...
srun --exclusive --gres=gpu:1 --ntasks=1 --nodes=1 --ntasks-per-node=1 -o "$LOG_DIR/out-stage2-gen.txt" -e "$LOG_DIR/error-stage2-gen.txt"  env CUDA_VISIBLE_DEVICES=2  python src/main.py --config ${PROJECT_DIR}/configs/BoneMarrow/CrossVal_1000/KB_Sapien/freq_None/Seed1/Llama.cfg --generate&
srun --exclusive --gres=gpu:1 --ntasks=1 --nodes=1 --ntasks-per-node=1 -o "$LOG_DIR/out-stage2-gen.txt" -e "$LOG_DIR/error-stage2-gen.txt"  env CUDA_VISIBLE_DEVICES=3  python src/main.py --config ${PROJECT_DIR}/configs/BoneMarrow/CrossVal_2000/KB_Sapien/freq_None/Seed1/Llama.cfg --generate&
wait
...
srun --exclusive --gres=gpu:1 --ntasks=1 --nodes=1 --ntasks-per-node=1 -o "$LOG_DIR/out-stage2-gen.txt" -e "$LOG_DIR/error-stage2-gen.txt"  env CUDA_VISIBLE_DEVICES=2  python src/main.py --config ${PROJECT_DIR}/configs/PBMC_CTL/CrossVal_1000/KB_Sapien/freq_None/Seed1/Llama.cfg --generate&
srun --exclusive --gres=gpu:1 --ntasks=1 --nodes=1 --ntasks-per-node=1 -o "$LOG_DIR/out-stage2-gen.txt" -e "$LOG_DIR/error-stage2-gen.txt"  env CUDA_VISIBLE_DEVICES=3  python src/main.py --config ${PROJECT_DIR}/configs/PBMC_CTL/CrossVal_2000/KB_Sapien/freq_None/Seed1/Llama.cfg --generate&
wait